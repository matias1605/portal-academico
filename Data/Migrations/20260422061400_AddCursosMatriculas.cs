...
{
    /// <inheritdoc />
    public partial class AddCursosMatriculas : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "MAT101", 4, 30, new TimeSpan(0, 10, 0, 0, 0), new TimeSpan(0, 8, 0, 0, 0), "Matemáticas I" },
                    { 2, true, "FIS201", 3, 25, new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 10, 0, 0, 0), "Física II" },
                    { 3, true, "PRG301", 5, 20, new TimeSpan(0, 16, 0, 0, 0), new TimeSpan(0, 14, 0, 0, 0), "Programación Web" }
                });
